...
class ChatOverlay(UIComponent):
    ...
    def __init__(
        ...
        *,
        ...
        # TODO
        try:
            self._font_msg = pg.font.Font("assets/fonts/Minecraft.ttf", 14)
            self._font_input = pg.font.Font("assets/fonts/Minecraft.ttf", 16)
        except Exception:
            self._font_msg = pg.font.SysFont(None, 14)
            self._font_input = pg.font.SysFont(None, 16)
